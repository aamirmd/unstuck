...
import { Answer, ClarityProfile } from "@/lib/types";
...
const MC_OPTIONS: Record<number, Record<string, string>> = {
    1: {
        a: "Plan every step first",
        b: "Start immediately, figure out details later",
        c: "Delay until I feel ready",
    },
    2: {
        a: "Exercise / physical activity",
        b: "Talk to friends",
        c: "Worry quietly / ruminate",
    },
    3: {
        a: "Clear deadlines",
        b: "Personal satisfaction",
        c: "External rewards (grades, recognition)",
    },
    4: {
        a: "Analyze all pros/cons",
        b: "Choose the easiest / most comfortable",
        c: "Flip a coin / act randomly",
    },
    5: {
        a: "Reflect deeply and adjust",
        b: "Take it personally",
        c: "Ignore or brush it off",
    },
    6: {
    ...
    7: {
        a: "Break down tasks and prioritize",
        b: "Avoid tasks and procrastinate",
        c: "Stress, overthink, and do nothing",
    },
    8: {
        a: "Gentle encouragement",
        b: "Firm, direct guidance",
        c: "Logical explanation and reasoning",
    },
};
...
const FALLBACK_PROFILE = {
    ...
    challenges: [
        ...
        "Managing overwhelm effectively",
    ],
...
export async function POST(request: Request) {
    try {
        ...
        const systemPrompt = `Generate a Clarity Profile in this JSON format without explaining your approach to me:
{
...
// `;
        ...
        return corsResponse(
            200,
            JSON.stringify({ clarityProfile: FALLBACK_PROFILE }),
        );
    }
}
